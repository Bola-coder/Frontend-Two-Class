    ...
    <section className={style.banner}>
      <div className={style.banner__text}>
        ...
        <p>
          ...
          consequatur, repellat labore ut sed doloremque quaerat doloribus
          numquam fugiat ducimus nesciunt iusto, recusandae blanditiis nihil
          laborum ipsa! Maxime, unde?
        </p>
